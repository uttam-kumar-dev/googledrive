<div class="card-body p-3 p-md-4 p-xl-5">
    ...
    if ($msg = session()->get_flash_message('error')) { ?>
        <div class="alert alert-info"><?= $msg ?></div>
    <?php } ?>

    <form action="<?= BASE_URL ?>services/auth.php" method="post">
        <div class="row gy-3 overflow-hidden">
            <div class="col-12">
                <div class="form-floating mb-2">
                    <input type="text" class="form-control" name="name" id="name" placeholder="Jhon due" required>
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="d-flex gap-2 gap-md-4 flex-column flex-md-row justify-content-md-end">
                <a href="<?= BASE_URL ?>" class="link-secondary text-decoration-none">Login to account</a>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
            <p class="my-3">Or continue with</p>
