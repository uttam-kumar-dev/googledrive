...
<body>
                ...
                <div class="card border w-inherit position-fixed">
                    <div class="card-body">
                        ...
                        <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                            ...
                            <li class="nav-item">
                                <a class="nav-link rounded-pill px-2" href="<?= BASE_URL ?>pages/home.php?page=my-drive"><i class="mdi mdi-book-lock me-1"></i> My Drive</a>
                            </li>
                            ...
                            <li class="nav-item">
                                <a class="nav-link rounded-pill px-2" href="<?= BASE_URL ?>pages/home.php?page=shared-files"> <i class="mdi mdi-account-multiple me-1"></i> Shared with me</a>
                            </li>
    ...
    <!-- contextmenu START -->
    <?php require_once '../components/contextmenu.html' ?>
    <?php require_once '../components/share.html' ?>
